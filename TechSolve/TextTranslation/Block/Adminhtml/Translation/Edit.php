...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize translation edit block
     *
     * @return void
     */
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('translation')->getId()) {
            return __("Edit Translation '%1'", $this->escapeHtml($this->_coreRegistry->registry('translation')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('texttranslation/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
